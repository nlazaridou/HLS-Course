...
int main() {
	...
	//Test 1: Sum 20 - should not end - should not win
	
	test_in_card = 2;
	test_deck[0].write(test_in_card);
	test_in_card = 17;
	test_deck[0].write(test_in_card);
	
	//Test 2: Sum 24 - should end - should not win
	...
	//Test 3: Sum 21 - should end - should win
	...
	//Test 4: Sum 21 at 2nd card - should end - should  win
	...
	// Test 5: Sum > 21 and Card Count > 5 but first 2 cards are aces - should end - should win
	...
	// Test 6: Sum > 21 and Card Count < 5 - should end - should not win
	...
	// Test 7: Card Count > 5 but Sum == 21 before - should end - should win
	...
	// Test 8: Sum < 21 - should end - should win
